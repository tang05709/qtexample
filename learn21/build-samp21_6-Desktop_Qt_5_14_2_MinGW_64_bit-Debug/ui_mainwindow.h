...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        labView->setGeometry(QRect(50, 20, 357, 500));
        labView->setFrameShape(QFrame::Box);
        labView->setFrameShadow(QFrame::Sunken);
        btnDetect = new QPushButton(centralwidget);
        btnDetect->setObjectName(QString::fromUtf8("btnDetect"));
        btnDetect->setGeometry(QRect(440, 490, 80, 20));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        btnDetect->setText(QCoreApplication::translate("MainWindow", "\350\257\206\345\210\253", nullptr));
    } // retranslateUi
