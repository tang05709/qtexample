...
#include <memory>
#include "../../samp_doc_viewer/HtmlHandler.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_HtmlHandler_t, stringdata0) + ofs \
...
void HtmlHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<HtmlHandler *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (HtmlHandler::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&HtmlHandler::targetChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (HtmlHandler::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&HtmlHandler::fileUrlChanged)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (HtmlHandler::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&HtmlHandler::textChanged)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (HtmlHandler::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&HtmlHandler::htmlTitleChanged)) {
                *result = 3;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject HtmlHandler::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_HtmlHandler.data,
    qt_meta_data_HtmlHandler,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *HtmlHandler::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_HtmlHandler.stringdata0))
